<script>
    ...
    let idcomponent = "account-" + generateId(20);
    let navmenus = [];
    //let accessview = null;
    ...
    onMount(async () => {
        ...
        //navmenus.push({name:"Profile",context:"profile",comp:null});
        //navmenus.push({name:"Contacts",context:"contacts",comp:null});
        //navmenus.push({name:"Passphase Hint",context:"passphasehint",comp:null});
        //navmenus.push({name:"Change Passphase",context:"changepassphase",comp:null});
        navmenus=navmenus;
    });
